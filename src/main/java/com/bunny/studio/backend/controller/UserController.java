...
public class UserController {
	...
	public ResponseEntity findById(@ApiParam(value = "Id of the user", required = true) @PathVariable("id") long id){
	...
	public void delete(@ApiParam(value = "Id of the user to be deleted", required = true) @PathVariable("id") long id) {
	   repo.deleteById(id);
	}
